...
with read_base():
    ...
    from ...yolov8.yolov8_darknet_l import model as teacher  # noqa
    from ...yolov8.yolov8_efficientnet_es import model as student  # noqa
teacher_ckpt = 'yolo_cspdarknet.pth'  # noqa: E501
model = dict(
    _scope_='mmrazor',
