...
with read_base():
    ...
    from ...DX_Faster_rcnn.faster_rcnn_resnest50_fpn import model as teacher  # noqa
    from ...DX_Faster_rcnn.faster_rcnn_r18_fpn import model as student  # noqa
teacher_ckpt = 'faster_resnest50_DX.pth'  # noqa: E501
model = dict(
    _scope_='mmrazor',
